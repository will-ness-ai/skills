...
- **[sandcastle](./sandcastle/SKILL.md)** — Loop a backlog of tickets (GitHub, Linear, or a JSON list) through Sandcastle's sandboxed agents AFK — implement then review, one ticket per iteration — and open a PR with the finished work. User-invoked.
